-- Populate Golf Courses from Logos Folder
-- This script adds golf courses based on the logos available in the public/logos folder
...
-- Insert golf courses based on available logos
...
(gen_random_uuid(), 'Gaylord Springs Golf Links', 'Nashville, TN', 'Championship golf course designed by Larry Nelson. Features Scottish-style links with challenging water features and beautiful landscaping.', 'public', 72, 18, '/logos/gaylord_springs_golf_links_text_logo.png', '/logos/golfcoursedefaultimage.png', NOW(), NOW()),

(gen_random_uuid(), 'The Honors Course', 'Ooltewah, TN', 'Exclusive private golf course designed by Pete Dye. Known for its challenging design and pristine conditions. Host of multiple amateur championships.', 'private', 72, 18, '/logos/the_honors_course_text_logo.png', '/logos/golfcoursedefaultimage.png', NOW(), NOW()),

(gen_random_uuid(), 'Torrey Pines Golf Course', 'La Jolla, CA', 'Iconic public golf course overlooking the Pacific Ocean. Features two championship courses and has hosted multiple PGA Tour events including the U.S. Open.', 'public', 72, 18, '/logos/torrey_pines_golf_course_text_logo.png', '/logos/golfcoursedefaultimage.png', NOW(), NOW()),

-- Generic/Default Courses (using default image)
...
-- Success message
SELECT 'Successfully populated golf courses from logos! Courses with custom logos: ' || 
