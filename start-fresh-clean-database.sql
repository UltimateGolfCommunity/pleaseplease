-- START FRESH: Clean Database Script
-- Run this in your Supabase SQL Editor to clear all historic data and start fresh

-- ===========================================
-- STEP 1: Clear all tee time related data
-- ===========================================
DELETE FROM tee_time_applications;
DELETE FROM tee_times;

-- ===========================================
-- STEP 2: Clear user activities and connections
-- ===========================================
DELETE FROM user_activities;
DELETE FROM user_connections;

-- ===========================================
-- STEP 3: Clear group related data
-- ===========================================
...
-- ===========================================
-- STEP 6: Clear badge and achievement data
-- ===========================================
