-- Supabase Database Schema for Golf Community
...
-- Now create child tables that reference the parent tables
...
-- User badges: users can view all, but only manage their own
...
-- User achievements: users can view all, but only manage their own
...
-- Golf courses: everyone can read, authenticated users can create
...
-- Tee times: everyone can read, authenticated users can create/manage their own
...
-- Tee time applications: users can view all, but only manage their own
...
-- Golf groups: everyone can read, authenticated users can create/manage their own
...
-- Group members: users can view all, but only manage their own membership
...
-- Group messages: users can view all, authenticated users can send
